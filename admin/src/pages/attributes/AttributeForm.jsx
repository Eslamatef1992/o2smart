...
const EMPTY = { nameEn: '', nameAr: '', keyName: '' };

export default function AttributeForm({ initial, onCancel, onSubmit }) {
    ...
    <div className="modal-backdrop" onClick={onCancel}>
      <div className="card modal" onClick={(e) => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-field">
            <label>Key</label>
            <input value={form.keyName} onChange={(e) => set('keyName', e.target.value)} required />
            <small>machine-readable identifier, e.g. storage, color</small>
          </div>
